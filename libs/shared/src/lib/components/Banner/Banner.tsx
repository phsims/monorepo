        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 space-x-1">
          <div className="col-span-6 flex flex-col justify-center">
            ...
            >
              ...
              <h2 className="text-3xl lg:text-5xl font-semibold mb-5 text-lightgrey md:4px lg:text-start text-center">
            ...
            >
              <p className="text-grey lg:text-lg font-normal mb-10 lg:text-start text-center">
                ...
                last-minute recipe searches and grocery store rushes? MealPlan
                Pro is here to simplify your life and make meal planning a
                breeze. Whether you're a seasoned chef or a kitchen newbie, our
                app is your key to stress-free meal planning and efficient
                grocery shopping.
              </p>
            </Fade>
            <Fade
